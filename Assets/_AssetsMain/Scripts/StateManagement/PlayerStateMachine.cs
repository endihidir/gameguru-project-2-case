...
public class PlayerStateMachine : IStateMachine, ITickable, IGameplayBootService
{
    ...
    public PlayerStateMachine(IGameplayManager gameplayManager, IPlayerInitializer playerInitializer, ICinemachineManager cinemachineManager)
    {
        ...
        _playerMoveState = new PlayerMoveState(playerInitializer, _cinemachineManager);
